...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    PT: {
      ...
      skill_design_tools: "Photoshop / Illustrator / Canva",
      ...
      timeline_date_3: "Jul 2023 - Jul 2026",
      ...
      proj_desc_10: "Hub de gestão de clientes e financeiro pros projetos freelancer do grupo. SPA em React + Vite + TypeScript sobre Firebase (Auth com Google, Firestore e Security Rules), com PDF de leads e regras de acesso por usuário. Em produção, usado no dia a dia dos projetos.",
      ...
      print_summary: "Estudante de Engenharia de Software (PUC Minas, 5º período), focado em desenvolvimento full-stack e mobile, do modelo de dados ao deploy. Atua como responsável pela estrutura de TI e pelo suporte da escola Rede Decisão (BH) e entrega produtos reais — de um SaaS multi-tenant em piloto com cliente a, em parceria com dois amigos, projetos freelancer de sistemas de gestão e apps Flutter. Base prévia em marketing digital e comunicação para redes sociais.",
      ...
      print_skill_design: "Design e Comunicação: Photoshop, Illustrator, Canva, Web Design, Marketing Digital, Identidade Visual.",
      ...
      print_exp_date_3: "Jul 2023 – Jul 2026",
      print_exp_task_3_1: "Atuação na equipe de comunicação/marketing do curso de Engenharia de Software, de julho de 2023 a julho de 2026, focando na criação de conteúdo técnico e engajamento da comunidade acadêmica.",
    ...
    EN: {
      ...
      profile_bio: "Software Engineering student (PUC Minas, 5th semester), focused on full-stack and mobile development, from data model to deploy. He is responsible for the IT structure and support of the Rede Decisão school (Belo Horizonte) and ships real products — from a multi-tenant SaaS in pilot with a client to, in partnership with two friends, freelance management systems and Flutter apps. With a prior background in digital marketing and social media communication.",
      ...
      proj_title_10: "Café Labs Admin",
      proj_desc_10: "A clients and finances management hub for the group's freelance projects. React + Vite + TypeScript SPA on Firebase (Google Auth, Firestore and Security Rules), with lead PDF export and per-user access rules. In production, used day to day across the projects.",
      proj_title_11: "Dindin — Finanças por Envelopes",
      ...
      print_summary: "Software Engineering student (PUC Minas, 5th semester), focused on full-stack and mobile development, from data model to deploy. He is responsible for the IT structure and support of the Rede Decisão school (Belo Horizonte) and ships real products — from a multi-tenant SaaS in pilot with a client to, in partnership with two friends, freelance management systems and Flutter apps. With a prior background in digital marketing and social media communication.",
      print_sect_skills: "Technical Skills",
      print_skill_ai: "Artificial Intelligence: Recommendation Algorithms, Programming Logic.",
      print_skill_design: "Design & Communications: Photoshop, Illustrator, Canva, Web Design, Digital Marketing, Visual Identity.",
      ...
      print_exp_date_3: "Jul 2023 – Jul 2026",
      print_exp_task_3_1: "Member of the course's communications/marketing team, from July 2023 to July 2026, producing technical content and driving academic community engagement.",
  ...
  const dossiers = {
    PT: {
      ...
      "exp-cafelabs": {
        title: "PROJETOS_FREELANCER // DOSSIÊ",
        role: "Desenvolvedor Freelancer",
        org: "Projetos com dois amigos",
      ...
      "exp-puc": {
        ...
        period: "Julho 2023 - Julho 2026",
        status: "CONCLUÍDO",
        desc: "Atuação de três anos na equipe de comunicação/marketing do curso, produzindo conteúdo e engajando a comunidade acadêmica no ecossistema de software.",
        tasks: [
    ...
    EN: {
      ...
      "exp-cafelabs": {
        title: "FREELANCE_PROJECTS // DOSSIER",
        role: "Freelance Developer",
        org: "Freelance projects with two friends",
      ...
      "exp-puc": {
        ...
        status: "COMPLETED",
        desc: "Three years on the course's communications/marketing team, producing content and driving academic community engagement.",
        tasks: [
